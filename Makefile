...
# Template: app
# Command: /usr/lib/qt/bin/qmake -o Makefile imageviewer.pro
#############################################################################
...
CXXFLAGS      = -pipe -O2 -march=x86-64 -mtune=generic -O2 -pipe -fstack-protector-strong --param=ssp-buffer-size=4 -Wall -W -D_REENTRANT -fPIC $(DEFINES) -std=c++11 -stdlib=libc++
...
LINK          = clang++
LFLAGS        = -Wl,-O1 -Wl, -std=c++1y -stdlib=libc++ -lc++abi -O1 -z relro
...
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		imageviewer.pro imageviewer.h imageviewer.cpp \
		main.cpp
...
install_target: first FORCE
	...
	-$(INSTALL_PROGRAM) $(QMAKE_TARGET) $(INSTALL_ROOT)/usr/share/doc/qt/examples/widgets/widgets/imageviewer/$(QMAKE_TARGET)
